venda = {'joao':1200, 'pedro': 500, 'anna':1300, 'maria':3000}
# se a resposta tiver uma condição, o if vem antes do for, caso queira apenas filtrar, o if vem por ultimo

meta = 1000
filtro = [valor * 0.1 if valor > meta else 0 for nome, valor in venda.items()]

print(filtro)


print('************************************************** \n')
# se abaixo de 1000 pedir 500
# se abaixo de 200 pedir 1000
...
filtrado = [(codigo, 1000) if qnt < 200 else (codigo, 500)  for codigo, qnt in estoque]
print(filtrado)
